			...
			<v-flex xs4>
				<v-layout column>
					<v-flex xs12>
						...
						<h5 class="headline my-2">
							<strong>Producers</strong>: <span v-for="(producer, index) in anime.producer" :key="index">{{producer.name}}<span v-if="anime.producer.length > index + 1">, </span></span><span v-if="anime.producer.length < 1">{{na}}</span>
						</h5>
						<h5 class="headline my-2">
							<strong>Licensors</strong>: <span v-for="(licensor, index) in anime.licensor" :key="index">{{licensor.name}}<span v-if="anime.licensor.length > index + 1">, </span></span><span v-if="anime.licensor.length < 1">{{na}}</span>
						</h5>
						<h5 class="headline my-2">
							<strong>Studios</strong>: <span v-for="(studio, index) in anime.studio" :key="index">{{studio.name}}<span v-if="anime.studio.length > index + 1">, </span></span><span v-if="anime.studio.length < 1">{{na}}</span>
						</h5>
						<h5 class="headline my-2">
							<strong>Source</strong>: {{anime.source || na}}
						</h5>
						<h5 class="headline my-2">
							<strong>Genres</strong>: <span v-for="(genre, index) in anime.genre" :key="index">{{genre.name}}<span v-if="anime.genre.length > index + 1">, </span></span><span v-if="anime.genre.length < 1">{{na}}</span>
						</h5>
						<h5 class="headline my-2">
			...
			<v-flex xs8>
				<v-layout column>
					<v-flex xs12>
						...
						<p class="headline my-2 text-justify">{{anime.synopsis}}</p>
						<div v-if="anime.background">
							<h4 class="display-1 my-5">Background:</h4>
							<p class="headline my-2 text-justify">{{anime.background}}</p>
						</div>
						<div v-if="(anime.related.Adaptation && anime.related.Adaptation.length > 0) || (anime.related[`Side story`] && anime.related[`Side story`].length > 0) || (anime.related.Summary && anime.related.Summary.length > 0) || (anime.related[`Parent story`] && anime.related[`Parent story`].length > 0)">
							<h4 class="display-1 my-5">Related Anime:</h4>
							<h5 class="headline my-2" v-if="anime.related.Adaptation">
							...
							<h5 class="headline my-2" v-if="anime.related[`Side story`]">
							...
							<h5 class="headline my-2" v-if="anime.related.Summary">
							...
							<h5 class="headline my-2" v-if="anime.related[`Parent story`]">
						...
						<div v-if="anime.opening_theme && anime.opening_theme.length > 0">
						...
						<div v-if="anime.ending_theme && anime.ending_theme.length > 0">
							<h4 class="display-1 my-5">Ending Theme:</h4>
