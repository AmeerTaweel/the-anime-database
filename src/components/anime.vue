        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-lg-9 mt-4">
                <div class="row">
                    ...
                    <div v-if="(anime.related.Adaptation && anime.related.Adaptation.length > 0) 
                        || (anime.related['Side story'] && anime.related['Side story'].length > 0)
                        || (anime.related.Summary && anime.related.Summary.length > 0)
                        || (anime.related['Parent story'] && anime.related['Parent story'].length > 0)" class="col-12">
                        <div class="row">
                    ...
                    <div class="col-12" v-if="anime.opening_theme && anime.opening_theme.length > 0">
                        <div class="row">
                            <h4 class="col-12 font-weight-bold">Opening Theme:</h4>
                            <h5 class="col-12" v-for="(theme, index) in anime.opening_theme" :key="index">{{theme}}</h5>
                            <br/>
                            <br/>
                        </div>
                    </div>
